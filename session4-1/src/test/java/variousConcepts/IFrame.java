...
public class IFrame {
	...
	public void iframe() {
		...
		//Cannot jump from one frame to the other without this
		//There is a difference between the defaultContent(); and ParentFrame();
		//ParentFrame(); takes you back to the parent frame of the webelement selected
		//defaultContent(); takes you back to the main html
